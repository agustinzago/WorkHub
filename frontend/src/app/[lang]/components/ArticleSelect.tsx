...
function selectedFilter(current: string, selected: string) {
  return current === selected
    ? "px-3 py-1 rounded-lg hover:underline dark:bg-red-700 dark-text-black-100"
    : "px-3 py-1 rounded-lg hover:underline dark:bg-red-400 dark-text-black-900";
}
                ...
                <li>
                  <Link
                    ...
                    className={`${
                      ...
                      "text-red-400"
                    }  hover:underline hover:text-red-400 transition-colors duration-200`}
                  >
