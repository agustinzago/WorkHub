...
export default function Pricing({ data }: PriceProps) {
  return (
    <section className="py-20 bg-gray-50 dark-text-black-100 m:py-12 lg:py-24">
      <div className="container px-4 mx-auto ">
        <div className="max-w-2xl mx-auto mb-16 text-center">
          <span className="font-bold tracking-wider uppercase dark:text-red-400">
            Pricing
          </span>
                ...
                <button
                  ...
                  className={`inline-block px-5 py-3 font-semibold tracking-wider text-center rounded   ${
                    plan.isRecommended
                      ...
                      : "dark:bg-red-400 dark-text-black-900"
                  }`}
                >
                  Get Started
                </button>
